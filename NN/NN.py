    ...
    for b in base:
        ...
        for days_ago in [1,3,5,8,10,12]:
            ...
            for obs in ["Tmax","Tmin","Tavg","DewPoint","WetBulb","PrecipTotal","Depart"]:
                ...
                case.append(weather[day][station]["Sunset"])
                case.append(weather[day][station]["Sunrise"])
...
def submit(net, mean, std):
    ...
    #
    out = csv.writer(open("west_nile_v5_400_2layer_mod2.csv", "w"))
